...
const DisplayWorkflowTime = (props: {date: Date | string | number; timestampKey: TIMESTAMP_KEYS}) => {
    const {date} = props;
    ...
    return (
        <div>
            <span>
                <Timestamp date={date} timestampKey={props.timestampKey} displayLocalDateTime={true} />
            </span>
        </div>
    );
};
