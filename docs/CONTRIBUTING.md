...
##### Responding to change requests in a PR
...
If a PR is taken over and uses any code from the previous PR the original author should be credited using `Co-authored-by` on the commits.
