...
Here are the steps to follow: 
  ...
  4. Run "nix develop .#buildEnv" (you will have to use the experimental feature flags on a fresh install, the features you need are "nix-command" and "flakes").
  5. Run "devenv up". 
  6. That is all you need. 
