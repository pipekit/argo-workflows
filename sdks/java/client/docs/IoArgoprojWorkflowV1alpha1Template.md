...
**clusterName** | **String** | Cluster to run this template on. If empty/omitted it&#39;ll run in the same cluster as the io.argoproj.workflow.v1alpha1. |  [optional]
...
**namespace** | **String** | Namespace run the template in. If empty/omitted it&#39;ll run in the same namespace as the io.argoproj.workflow.v1alpha1. |  [optional]
